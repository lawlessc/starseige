 ...
 */
public class LaserRenderHook implements IRenderHook {
   ...
   // float inter;
    ...
    public LaserRenderHook(Beam parent , GLSLShader shader)
    {
        this.parent=parent;
        this.shader = shader;
    }
    ...
    public void beforeRendering(int i) {
        ...
        shader.setUniform("u_time", (SingletonObjects.runningTime*0.01f));

        shader.setUniform("lengthmult",(parent.distance/8.0f));
        shader.setUniform("originPoint",parent.Startpoint);
        shader.setUniform("endpoint",parent.Endpoint);
