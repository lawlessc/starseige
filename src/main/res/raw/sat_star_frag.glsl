...
//    sample3 = texture2D(textureUnit0, vec2(v_texCoord.x - step, v_texCoord.y + step));
    ...
    {
        sample0 = texture2D(textureUnit1, vec2(v_texCoord.x - step, v_texCoord.y - step));
        sample1 = texture2D(textureUnit1, vec2(v_texCoord.x + step, v_texCoord.y + step));
        sample2 = texture2D(textureUnit1, vec2(v_texCoord.x + step, v_texCoord.y - step));
        sample3 = texture2D(textureUnit1, vec2(v_texCoord.x - step, v_texCoord.y + step));
    }
 ...
 //    mediump float alphab = smoothstep(SmoothCenter - smoothie,
     ...
     else if(rendermode==0 || rendermode == 3)
    {
